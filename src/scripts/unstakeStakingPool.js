...
async function unstakeEthFromStakingPool(stakingPoolAddress, amountToUnstake) {
    try {
        ...
        console.log(`Unstaking ${amountToUnstake} ETH from StakingPool at address: ${stakingPoolAddress}`);
        ...
        const stakingContract = new ethers.Contract(stakingPoolAddress, stakingABI, sender);
        ...
        console.log(`Successfully unstaked ${amountToUnstake} ETH from the staking contract.`);
    } catch (error) {
