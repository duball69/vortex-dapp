...
async function sendEthToStakingPool(stakingPoolAddress) {
    try {
        ...
        console.log(`Sending 0.01 ETH to StakingPool at address: ${stakingPoolAddress}`);
        ...
        console.log(`Successfully sent ${ethers.formatEther(amountToSend)} ETH to the staking contract.`);
    } catch (error) {
